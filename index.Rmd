...
- friendly/prep matches: scout one team
...
Also, to compare players/teams, `number of attempts` needs to be a consistent measure of opportunity across players/teams
...
- efficiency
- "efficiency plus one" (efficiency but also taking into account the opposition's answering attack)
